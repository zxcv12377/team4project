          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center space-x-2 ">
              <Link to="/" className="flex items-center space-x-2">
                <img
                  src="/STRONGBERRY1.png"
                  alt="logo"
                  className="w-12 h-12 object-contain hover:text-red-400"
                />
                <span className="text-2xl font-bold text-red-400 hover:text-red-700">
                  STRONGBERRY
                </span>
              </Link>
            </div>
            ...
            <div className="hidden lg:flex space-x-6 items-center">
              ...
              {isLoggedIn ? (
                ...
                <div className="flex gap-2">
                  ...
                  <Link
                    to="/register"
                    className="px-3 py-1 text-sm rounded bg-red-400 text-white"
                  >
                    회원가입
                  </Link>
                </div>
